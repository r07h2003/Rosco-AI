...
|---|---|---|
| SendBlue | iMessage API layer | Only reliable way to send/receive iMessages programmatically |
...
Built with [Boop Agent SDK](https://github.com/raroque/boop-agent) by raroque — an open-source Claude agent framework with persistent memory.

---

*Built by [Rohan Harishchandrakar](https://linkedin.com/in/rohan-harishchandrakar) · [Portfolio](https://r07h2003.github.io/Rohan-)*
